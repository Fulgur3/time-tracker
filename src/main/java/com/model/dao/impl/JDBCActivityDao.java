...
import com.model.dao.impl.mapper.ActivityMapper;
import com.model.dao.impl.mapper.UserMapper;
import com.model.entity.Activity;
import com.model.entity.Authority;
import com.model.entity.User;
import com.model.dao.ActivityDao;
...
public class JDBCActivityDao implements ActivityDao {
    ...
    private void fillStatement(Activity entity, PreparedStatement ps) throws SQLException {
        ...
        ps.setLong(5, entity.getDuration() != null ? entity.getDuration().getSeconds() : 0);
        ps.setString(6, entity.getPriority().name());
