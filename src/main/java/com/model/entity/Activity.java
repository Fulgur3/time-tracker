...
public class Activity {
    ...
    public Activity(long id, String name, String description, LocalDateTime startTime, LocalDateTime endTime, Duration duration, ActivityPriority priority, ActivityStatus status, List<User> users, List<ActivityRequest> activityRequests) {
        this.id = id;
        this.name = name;
    ...
    public static class Builder {
        ...
        public Activity build() {
            ...
            activity.setPriority(importance);
